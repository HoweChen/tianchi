define([
   ...
   *
   */
  Handlebars.registerHelper("each_compare_list_field",
   ...
   *
   */
  Handlebars.registerHelper("each_compare_keys",
    function (source, compare, options) {
      var newSource = [];
      if (source) {
   ...
   *
   */
  Handlebars.registerHelper("each_compare_field",
    function (source, compare, options) {
   ...
   *
   */
  Handlebars.registerHelper("each_compare_title",
    function (source, compare, options) {
